         ...
         <fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label>ของหวาน:</label>
                    <input type="checkbox" id="sport" name="interests" value="sport">
                    <label for="sport">เค้กสตอเบอร์รี่</label>
                    <input type="checkbox" id="music" name="interests" value="music">
                    <label for="music">บานานอฟฟี่</label>
                    <input type="checkbox" id="art" name="interests" value="art">
                    <label for="art">ช็อคโกแลตดูไบ</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">ไอศกรีม</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">เค้กวนิลา</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">ถังหูลู่</label>
                </div>
            </fieldset>
...
```
- ภาพผลลัพธ์:
![lab_6](https://github.com/user-attachments/assets/86f1bbb1-982a-46ab-bd8d-285eb270d56d)
